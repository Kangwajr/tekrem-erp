...
import { Brain, Bot, Cpu, ArrowRight } from 'lucide-react';
...
const AiMl = () => {
  const features = [
    ...
    },
    {
      ...
      title: 'AI Solutions',
      description: 'Custom AI solutions for process automation and decision making.',
    },
    {
      icon: <Cpu className="h-8 w-8" />,
      title: 'Deep Learning',
      description: 'Neural networks and deep learning models for complex problems.',
    },
  ];
